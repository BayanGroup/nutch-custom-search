...
public class OPICScoringFilter implements ScoringFilter {
	...
	/**
	 * Set to 0.0f (unknown value) - inlink contributions will bring it to a correct level. Newly discovered pages have
	 * at least one inlink.
	 */
	@Override
	...
	public CrawlDatum distributeScoreToOutlinks(Text fromUrl, ParseData parseData,
			Collection<Entry<Text, CrawlDatum>> targets, CrawlDatum adjust, int allCount) throws ScoringFilterException {
