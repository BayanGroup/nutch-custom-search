...
import ir.co.bayan.simorq.zal.nutch.plugin.css.config.TypeDef;
 ...
 * 
 */
public class CssSelectorIndexingFilter implements IndexingFilter {

	private static final Logger logger = Logger.getLogger(CssSelectorIndexingFilter.class);
	...
	public NutchDocument filter(NutchDocument doc, Parse parse, Text text, CrawlDatum crawlDatum, Inlinks inlinks)
		...
		if ("true".equals(metadata.get(CssSelectorParseFilter.MATCHED_DOC))) {
