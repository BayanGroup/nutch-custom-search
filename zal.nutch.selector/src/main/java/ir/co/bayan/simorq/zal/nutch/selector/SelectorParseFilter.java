...
public class SelectorParseFilter implements HtmlParseFilter {

	public static final String MATCHED_DOC = "matched-doc";

	private static final Logger logger = Logger.getLogger(SelectorParseFilter.class);

	private Configuration configuration;
	private SelectorBasedExtractor extractor;
	...
	private void initConf() throws UnsupportedEncodingException, JAXBException {
		extractor = new SelectorBasedExtractor(SelectorConfiguration.readConfig(configuration));
	}
